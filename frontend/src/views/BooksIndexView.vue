...
<template>
  <section>
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex justify-end mb-6">
        <button class="inline-block bg-red-600 text-white font-semibold px-5 py-2 rounded hover:bg-red-700 transition"
          @click="deleteLastBook">- Delete Book
        </button>
      </div>
      <div class="flex justify-end mb-6">
          ...
          <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 p-6 border border-gray-200">
            ...
            <div class="bg-gray-50 rounded-lg p-3 mb-4">
              <div class="flex justify-between text-sm">
                ...
                <span class="font-semibold">${{ Formatter.formatPriceToCOP(book.price) }} COP</span>
              </div>
            </div>
